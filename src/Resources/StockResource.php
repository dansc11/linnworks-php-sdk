...
class StockResource extends BaseResource
{
    ...
    {
        return json_decode(Factory::GetResponse("Stock/GetStockConsumption", "stockItemId=" . $stockItemId . "&locationId=" . $locationId . "&startDate=" . $startDate . "&endDate=" . $endDate . "", $ApiToken, $ApiServer));
    }
